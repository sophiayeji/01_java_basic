...
public class PrintEx03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1)로그인\t2)회원가입\t3)오시는길");
		System.out.println("C:\\coupang\\img_file_repo");
		System.out.println("선생님이 말씀하셨다. \"안녕\"");
		System.out.println("\n==============\n");
		...
		Date time1 = new Date();
		System.out.println(time1);// Fri Feb 17 20:23:44 KST 2023
		
		long time2 = System.currentTimeMillis();
		System.out.println(time2); // 1676633221993
		...
		DecimalFormat df = new DecimalFormat("#,##0"); // 세글자부터 , 추가 
