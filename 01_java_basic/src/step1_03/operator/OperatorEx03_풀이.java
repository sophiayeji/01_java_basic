...
public class OperatorEx03_풀이 {
	...
	public static void main(String[] args) {
		...
		System.out.println("평균점수 :" + ((100+88+92)/3) + "점");
		
		//문제3) 밑변이 3이고 높이가 7인 삼각형 넓이 출력 (삼각형의 넓이 구하는 공식 : 밑변 * 높이 / 2)
		System.out.println("삼각형의 넓이 :" + ((3*7)/2) + "cm");
			
		//문제4) 100초를 1분 40초로 출력
		System.out.println((100/60) + "분" + (100%60) + "초");
		
		//문제5) 800원에서 500원짜리 개수와 100원짜리 개수 출력
		System.out.println("500원짜리 개수 :" + (800/500) + "개" );
		System.out.println("100원짜리 개수 :" + (800%500)/100 + "개"); 
