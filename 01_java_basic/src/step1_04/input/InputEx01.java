...
import java.util.Scanner; //렌트선언! 

public class InputEx01 {

	public static void main(String[] args) {
		
	   // Scanner 변수명 = new Scanner(System.in); // 객체지향의 문법  
		
		// 코드의 시작부분에서 한번만 작성한다. 
		Scanner scan = new Scanner(System.in);
        
		System.out.print("상품 가격을 입력하세요: ");
		int getProductPrice = scan.nextInt(); // nextInt(); 메서드를 통하여 숫자를 입력받는다. ("숫자"를 입력받는 기능)
        
		System.out.println("입력하신 상품 가격은" + getProductPrice + "원 입니다.");
		System.out.println("부가세" + ((getProductPrice * 0.1)) + "원 입니다.");
