...
public class IfEx13 {
	...
	public static void main(String[] args) {
		...
		// 0 ~ 9 사이의 랜덤 값 
		//System.out.println(ran.nextInt(10)); //0-9까지 10개(범위)  
		int rNum1 = ran.nextInt(10);
		System.out.println(rNum1);
		// 100~ 200사이의 랜덤 값 
		int rNum2 = ran.nextInt(101) + 100; // 0~100까지 101개(범위)
		System.out.println(rNum2);		
		//-3~3사이의 랜덤 값
		int rNum3 = ran.nextInt(7) - 3; // ~3~3까지 7개(범위)
